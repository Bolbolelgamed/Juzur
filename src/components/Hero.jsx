...
export default function Hero() {
  ...
  return <section className="hero hero-carousel" aria-label={t.hero.label}>
    ...
    <div className="hero-product-gallery reveal delay" id="heroGallery">
      <div className="hero-main-photo"><video id="heroVideo" className="hero-gallery-video is-visible" src="/assets/juzur-hero-video.mp4" autoPlay muted loop controls playsInline preload="auto" poster="/assets/juzur-tray-studio.jpg" aria-label={t.hero.videoAlt} /><img id="heroPreviousImage" className="hero-gallery-layer hero-gallery-layer-previous" src="/assets/juzur-tray-studio.jpg" alt="" aria-hidden="true" style={{ objectPosition: '50% 50%' }} /><img id="heroCurrentImage" className="hero-gallery-layer hero-gallery-layer-current is-visible" src="/assets/juzur-tray-studio.jpg" alt={t.images.studio} fetchPriority="high" style={{ objectPosition: '50% 50%' }} /></div>
