export const locales = {
  en: {
    ...
    hero: { label: 'SofaTray by Juzur hero', eyebrow: 'Premium Wooden Sofa Tray', title1: 'Everything you need.', title2: 'Right beside you.', support: 'Designed to make life easier.', text: 'Coffee. Phone. Remote. Beautifully organized.', view: 'View Product', special: 'Launch price', priceLabel: 'Launch price: EGP 1,999, previously EGP 2,499', trustLabel: 'Product trust signals', wood: 'Handcrafted Zan Wood', payment: 'Cash on Delivery', delivery: 'Delivery within 4–7 days', scroll: 'Scroll', mediaLabel: 'Choose hero product media', videoPlay: 'Play SofaTray hero video', videoAlt: 'SofaTray by Juzur in use' },
  ...
  ar: {
    meta: { title: 'Juzur | ترابيزة الكنبة الخشبية', description: 'ترابيزة خشبية لذراع الكنبة من Juzur، مصنوعة بعناية علشان تخلي قهوتك وموبايلك والريموت دايمًا جنبك.' },
    nav: { label: 'التنقل الرئيسي', product: 'المميزات', video: 'شوفها وهي بتُستخدم', wood: 'خشب الزان', gift: 'هدية مميزة', faq: 'الأسئلة الشائعة', order: 'اطلبها دلوقتي', menuOpen: 'افتح القائمة', menuClose: 'أغلق القائمة', switchLanguage: 'التبديل إلى الإنجليزية' },
    ...
    faq: { eyebrow: 'قبل ما تطلب', title: 'إجابات واضحة على أهم أسئلتك', items: [['التوصيل بياخد قد إيه؟', 'التوصيل بيتم عادةً خلال ٤–٧ أيام من وقت تسجيل الطلب.'], ['ترابيزة الكنبة مصنوعة من إيه؟', 'مصنوعة يدويًا من خشب الزان الطبيعي، بتشطيب ناعم وشكل أنيق يليق ببيتك.'], ['ممكن أحط عليها إيه؟', 'تقدر ترتّب عليها الكوب، والموبايل، والريموت، والتسالي، والحاجات الصغيرة اللي بتحب تفضل جنبك.'], ['الدفع بيكون إزاي؟', 'الدفع عند الاستلام.'], ['تكلفة التوصيل بتتحسب إزاي؟', 'الشحن: ٥٠ ج.م للقاهرة والجيزة | ٧٥ ج.م لباقي المحافظات (الدفع عند الاستلام).']] },
    checkout: { eyebrow: 'الدفع عند الاستلام', title: 'كمّل طلبك في خطوات بسيطة', delivery: 'التوصيل خلال ٤–٧ أيام', offerLabel: 'السعر بعد الخصم 2,000 جنيه، بدلًا من 2,500 جنيه. وفّر 500 جنيه.', price: 'السعر بعد الخصم', intro: 'اكتب بياناتك واضغط «تأكيد الطلب» لإرسال طلبك.', shippingEstimate: 'الشحن: ٥٠ ج.م للقاهرة والجيزة | ٧٥ ج.م لباقي المحافظات (الدفع عند الاستلام).', trustBadge: 'مش مطلوب دفع أونلاين — الدفع كاش عند استلام الطلب.', labels: { fullName: 'الاسم بالكامل', phone: 'رقم الموبايل', governorate: 'المحافظة', areaCity: 'المنطقة أو المدينة', detailedAddress: 'عنوان التوصيل بالتفصيل', landmark: 'علامة مميزة قريبة (اختيارية)', quantity: 'عدد القطع' }, select: 'اختار محافظتك', submit: 'تأكيد الطلب والدفع عند الاستلام', sending: 'جاري إرسال طلبك...', errors: { fullName: 'من فضلك اكتب اسمك بالكامل.', phoneEmpty: 'من فضلك اكتب رقم الموبايل.', phoneInvalid: 'اكتب رقم موبايل مصري صحيح يبدأ بـ 010 أو 011 أو 012 أو 015.', governorate: 'اختار محافظتك.', areaCity: 'اكتب المنطقة أو المدينة.', detailedAddress: 'اكتب عنوان التوصيل بالتفصيل.', quantity: 'اختار قطعة واحدة أو أكثر.', summary: 'راجع الخانات الموضحة، وبعدها حاول مرة تانية.' }, statuses: { sending: 'جاري إرسال طلبك...', success: 'تم إرسال طلبك بنجاح. شكرًا لاختيارك Juzur.', failure: 'للأسف، ماقدرناش نرسل طلبك. اتأكد من اتصالك بالإنترنت وحاول مرة تانية.' } },
    modal: { label: 'معاينة صورة المنتج', close: 'أغلق معاينة الصورة', previous: 'الصورة السابقة', next: 'الصورة التالية' },
    footer: { tagline: 'منتجات خشبية مصنوعة بعناية، علشان تضيف راحة وأناقة لتفاصيل يومك. تنفيذ Techwood-Art.', contactLabel: 'خيارات التواصل', support: 'عندك استفسار؟ إحنا هنا لمساعدتك.', contact: 'للطلب والاستفسار: 01042511891', whatsapp: 'واتساب', call: 'اتصل بـ Juzur على 01042511891' },
...
function replaceProductName(value, replacements) {
  if (typeof value === 'string') return replacements.reduce((copy, [from, to]) => copy.replaceAll(from, to), value);
  if (Array.isArray(value)) return value.map((item) => replaceProductName(item, replacements));
  if (value && typeof value === 'object') Object.keys(value).forEach((key) => { value[key] = replaceProductName(value[key], replacements); });
  return value;
}

replaceProductName(locales.en, [['SofaTray by Juzur', 'Juzur Sofa tray'], ['SofaTray', 'Juzur Sofa tray'], ['Sofa Tray', 'Juzur Sofa tray']]);
...
locales.en.faq.items[4][1] = locales.en.checkout.shippingEstimate;
...
locales.en.product.dimensionValue = '35 × 24 × 4.5 cm';
locales.en.material = {
...
locales.ar.product.dimensionValue = '٣٥ × ٢٤ × ٤٫٥ سم';

// Do not promise inspection before payment unless the courier explicitly supports it.
locales.en.checkout.trustBadge = 'No online payment is required — pay Cash on Delivery when your order arrives.';
locales.ar.checkout.trustBadge = 'مش مطلوب دفع أونلاين — الدفع كاش عند استلام الطلب.';
...
locales.ar.footer.contactLabel = '\u062e\u064a\u0627\u0631\u0627\u062a \u0627\u0644\u062a\u0648\u0627\u0635\u0644';
locales.ar.footer.support = '\u0639\u0646\u062f\u0643 \u0627\u0633\u062a\u0641\u0633\u0627\u0631\u061f \u0625\u062d\u0646\u0627 \u0647\u0646\u0627 \u0644\u0645\u0633\u0627\u0639\u062f\u062a\u0643.';
locales.ar.footer.contact = '\u0644\u0644\u0637\u0644\u0628 \u0648\u0627\u0644\u0627\u0633\u062a\u0641\u0633\u0627\u0631: 01042511891';
locales.ar.footer.email = '\u0627\u0644\u0628\u0631\u064a\u062f';
locales.ar.footer.whatsapp = '\u0648\u0627\u062a\u0633\u0627\u0628';
